        ...
        <form onSubmit={(e) => submitLoginData(e)}>
          ...
          <div className="mb-3">
            ...
            <input
              ...
              name="password"
            />
            <span><img onClick={togglePassword} className="eye-icon" src="https://cdns.iconmonstr.com/wp-content/assets/preview/2017/240/iconmonstr-eye-9.png" alt="eye-icon" /></span>
